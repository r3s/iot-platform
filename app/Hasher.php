...
class Hasher
{
	...
	const PBKDF2_SALT_BYTE_SIZE = 12;
	...
	public function create_hash($password) {
	    ...
	    return self::TAG . self::SEPARATOR . self::PBKDF2_HASH_ALGORITHM . self::SEPARATOR . self::PBKDF2_ITERATIONS . self::SEPARATOR .  $salt . self::SEPARATOR . 
